...
class VerifyClaimsOpPage extends StatefulWidget {
  ...
  VerifyClaimsOpPage({this.request, this.isForVerification, this.member});
  @override
  _VerifyClaimsOpPageState createState() => _VerifyClaimsOpPageState();
}

class _VerifyClaimsOpPageState extends State<VerifyClaimsOpPage> implements IVerificationView {
  ...
  Future<void> onSuccess(SignUpResponse response, String sender) async {
    ...
    if(sender == 'request-v'){
      ...
      print('S account-v');
      _claimsPresenter.sendClaimOpRequest(widget?.request,this.context, widget?.member);
      _timer.cancel();
    }
