...
class VerifyRequestLogPage extends StatefulWidget {
  final String availment;
  ...
  final String doctor;
  final List<String> selectedProceduresList;
  final List<File> fileList;


  final bool isForVerification;

  VerifyRequestLogPage({
    this.availment,
    this.availDate,
    this.username,
    this.cardNo,
    ...
    this.isForVerification
  });
  @override
  _VerifyRequestLogPageState createState() => _VerifyRequestLogPageState();
}

class _VerifyRequestLogPageState extends State<VerifyRequestLogPage> implements IVerificationView {
  final IVerificationPresenter _mPresenter = VerificationPresenter();
  IRequestLogPresenter _rPresenter = RequestLogPresenter();
  ...
  Future<Member> _navigateToHomePage(String cardNo) async {
    ...
    String url = '${baseUrl}MemberInfo?userid=$apiUser&password=$apiPass&cardno=$cardNo&frommain=0';
  ...
  Future<void> onSuccess(SignUpResponse response, String sender) async {
    ...
    if(sender == 'request-v'){
      ...
      LogRequest request = LogRequest(
        availType: widget.availment,
        availDate: widget.availDate,
        username: widget.username,
        cardNo: widget.cardNo,
        providerCode: widget.provider,
        patient: widget.patient,
        complaint: widget.complaints,
        contactNo: widget.contactNo,
        doctors: widget.doctor,
        attachments: widget.fileList,
        procedures: widget.selectedProceduresList,
      );
      _rPresenter.sendLogRequest(request);
      showMessageDialog();
    }
  ...
  void showMessageDialog(){
    ...
    showDialog(
        ...
        builder: (_) => new AlertDialog(
          title: new Text(""),
          content: new Text('Request successfully posted',textAlign: TextAlign.center),
          actions: <Widget>[
            FlatButton(
              child: Text('OK'),
              onPressed: () {
