...
import 'package:av_asian_life/data_manager/no_connection_page.dart';
...
class _SignUpLoginPageState extends State<SignUpLoginPage> implements ILoginView {
  ...
  initGetRegistrationDetails()async{
    MyPreferenceHandler myPreferenceHandler = MyPreferenceHandler();
    User user = await myPreferenceHandler.getRegDetails();
      print("User: ${user.username}");

     _username = user.username;
     _initPassword = user.password;
  }
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    child: Align(
                      ...
                      child: Container(
                        ...
                        child: _cancelFingerprint == true ? InkWell(
                          onTap: (){
                            // Navigator.push(context,
                  ...
                  _cancelFingerprint == false ? _profilePicture() : _profilePicture(),
            ...
            Align(
              ...
              child: Column(
                ...
                Container(
                  ...
                  child: Text('FingerPrint Authentication', style: TextStyle(fontSize: 20),)
                ),
                Container(
                  margin: EdgeInsets.only(top: 5),
                  child: Text('Confirm fingerprint to continue       ')
                )
              ]
             ),
            ),
  ...
  Widget _setquickView(BuildContext context,) {
    final _height = MediaQuery.of(context).size.height;
    return Container(
       decoration: myAppBackground(),
       height: _height,
