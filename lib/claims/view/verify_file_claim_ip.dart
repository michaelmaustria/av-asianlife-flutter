...
class VerifyClaimsIpPage extends StatefulWidget {
  ...
  VerifyClaimsIpPage({this.request, this.isForVerification, this.member});
  @override
  _VerifyClaimsIpPageState createState() => _VerifyClaimsIpPageState();
}

class _VerifyClaimsIpPageState extends State<VerifyClaimsIpPage> implements IVerificationView {
  ...
  Future<void> onSuccess(SignUpResponse response, String sender) async {
    ...
    if(sender == 'request-v'){
      ...
      print('S account-v');
      _claimsPresenter.sendClaimIpRequest(widget?.request, context, widget?.member);
      _timer.cancel();
    }
