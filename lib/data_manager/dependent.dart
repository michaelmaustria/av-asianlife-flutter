...
//
//     final dependent = dependentFromJson(jsonString);

import 'dart:convert';

List<Dependent> dependentFromJson(String str) => List<Dependent>.from(json.decode(str).map((x) => Dependent.fromJson(x)));

String dependentToJson(List<Dependent> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
